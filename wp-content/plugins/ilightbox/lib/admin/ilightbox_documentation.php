...
GROUPNAME = The name of grouped lightboxes</textarea>
				...
				<ul class="noBull clearfix">
					<li class="clearfix">
						<span class="counter">1.6.1:</span>
						<span class="description">
							<strong>Optimized:</strong> Galleries deep-linking.<br>
							<strong>Optimized:</strong> Galleries caption detection.<br>
							<strong>Added:</strong> Import/Export page.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
						<span class="counter">1.6.0:</span>
						<span class="description">
							<strong>Optimized:</strong> Galleries activating method.<br>
							<strong>Optimized:</strong> Galleries & image/video links with ajax themes.<br>
							<strong>Added:</strong> iLightBox jQuery version 2.2.1.<br>
							<strong>Added:</strong> Cache feature to drop database requests and speed up page load.<br>
							<strong>Added:</strong> "Once" feature for binded galleries to run just once.<br>
							<strong>Fixed:</strong> Some bugs and new improvements.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
						<span class="counter">1.5.8:</span>
						<span class="description">
							<strong>Fixed:</strong> multiple lightbox issue when another lightbox plugin is activated.<br>
							<strong>Fixed:</strong> multiple lightbox issue for nextGen & jetPack gallery.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
						<span class="counter">1.5.7:</span>
						<span class="description">
							<strong>Fixed:</strong> errors when DEBUG_MODE is on.<br>
							<strong>Fixed:</strong> errors when activating the iLightBox.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
						<span class="counter">1.5.6:</span>
						<span class="description">
							<strong>Added:</strong> iLightBox jQuery version 2.2.0.<br>
							<hr>
						</span>
					</li>
					<li class="clearfix">
						<span class="counter">1.5.5:</span>
						<span class="description">
							<strong>Added:</strong> iLightBox jQuery version 2.1.8.<br>
							<strong>Fixed:</strong> Some bugs and new improvements.<br>
							<hr>
						</span>
					</li>
