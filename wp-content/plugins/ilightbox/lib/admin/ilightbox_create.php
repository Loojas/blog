					...
					<ul class="item_listing">
						<li class="col span_1">
							...
							<div class="section collapsed clearfix">
								...
								<textarea class="javascript" name="socialButtons" placeholder=""><?php echo @htmlentities(stripslashes($gallery['socialButtons']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<div class="clear"></div>
								<small>Sets the social buttons. For get more information about this field refer to the documentation.</small>
							...
							<div class="section collapsed clearfix">
								...
								<div class="clear"></div>
								<textarea class="javascript" name="onAfterChange"><?php echo @htmlentities(stripslashes($gallery['onAfterChange']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onAfterLoad">onAfterLoad</label>
								<small>A function to call when the content loads.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onAfterLoad"><?php echo @htmlentities(stripslashes($gallery['onAfterLoad']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onBeforeChange">onBeforeChange</label>
								<small>A function to call before the window changes.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onBeforeChange"><?php echo @htmlentities(stripslashes($gallery['onBeforeChange']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onBeforeLoad">onBeforeLoad</label>
								<small>A function to call before the content loads.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onBeforeLoad"><?php echo @htmlentities(stripslashes($gallery['onBeforeLoad']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								...
								<div class="clear"></div>
								<textarea class="javascript" name="onEnterFullScreen"><?php echo @htmlentities(stripslashes($gallery['onEnterFullScreen']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								...
								<div class="clear"></div>
								<textarea class="javascript" name="onExitFullScreen"><?php echo @htmlentities(stripslashes($gallery['onExitFullScreen']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onHide">onHide</label>
								<small>A function to call when the window hides.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onHide"><?php echo @htmlentities(stripslashes($gallery['onHide']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onOpen">onOpen</label>
								<small>A function to call when the iLightBox opens.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onOpen"><?php echo @htmlentities(stripslashes($gallery['onOpen']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onRender">onRender</label>
								<small>A function to call when the content renders.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onRender"><?php echo @htmlentities(stripslashes($gallery['onRender']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								<hr>
								
								<label class="label" for="onShow">onShow</label>
								<small>A function to call when the window comes into view.</small>
								<div class="clear"></div>
								<textarea class="javascript" name="onShow"><?php echo @htmlentities(stripslashes($gallery['onShow']), ENT_QUOTES, 'UTF-8'); ?></textarea>
								
							</div>
							
							<div class="section collapsed clearfix">
								<h3 class="title">Labels</h3>
								<input type="text" class="full" name="close" value="<?php echo @esc_attr(stripslashes($gallery['close'])); ?>" placeholder="Close" />
								<div class="clear"></div>
								<small>The default is '<code>Close</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="enterFullscreen" value="<?php echo @esc_attr(stripslashes($gallery['enterFullscreen'])); ?>" placeholder="Enter Fullscreen (Shift+Enter)" />
								<div class="clear"></div>
								<small>The default is '<code>Enter Fullscreen (Shift+Enter)</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="exitFullscreen" value="<?php echo @esc_attr(stripslashes($gallery['exitFullscreen'])); ?>" placeholder="Exit Fullscreen (Shift+Enter)" />
								<div class="clear"></div>
								<small>The default is '<code>Exit Fullscreen (Shift+Enter)</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="slideShowLabel" value="<?php echo @esc_attr(stripslashes($gallery['slideShowLabel'])); ?>" placeholder="Slideshow" />
								<div class="clear"></div>
								<small>The default is '<code>Slideshow</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="nextLabel" value="<?php echo @esc_attr(stripslashes($gallery['nextLabel'])); ?>" placeholder="Next" />
								<div class="clear"></div>
								<small>The default is '<code>Next</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="previousLabel" value="<?php echo @esc_attr(stripslashes($gallery['previousLabel'])); ?>" placeholder="Previous" />
								<div class="clear"></div>
								<small>The default is '<code>Previous</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="loadImage" value="<?php echo @esc_attr(stripslashes($gallery['loadImage'])); ?>" placeholder="An error occurred when trying to load photo." />
								<div class="clear"></div>
								<small>The default is '<code>An error occurred when trying to load photo.</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="loadContents" value="<?php echo @esc_attr(stripslashes($gallery['loadContents'])); ?>" placeholder="An error occurred when trying to load contents." />
								<div class="clear"></div>
								<small>The default is '<code>An error occurred when trying to load contents.</code>'.</small>
								<hr>
								
								<input type="text" class="full" name="missingPlugin" value="<?php echo @esc_attr(stripslashes($gallery['missingPlugin'])); ?>" placeholder="The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin</a>." />
								<div class="clear"></div>
...
?>
			<div class="slide" style="display: block;">
				...
				<div class="section collapsed">
					...
					<input type="text" pattern="slides[_i_][caption]|id,name" name="slides[<?php echo $key; ?>][caption]" id="slides[<?php echo $key; ?>][caption]" placeholder="Text" value="<?php echo esc_attr(stripslashes(@$data['caption'])); ?>" class="large" />
					<div class="clear"></div>
					...
					<input type="text" pattern="slides[_i_][title]|id,name" name="slides[<?php echo $key; ?>][title]" id="slides[<?php echo $key; ?>][title]" placeholder="Text" value="<?php echo esc_attr(stripslashes(@$data['title'])); ?>" class="large" />
					<div class="clear"></div>
					...
					<small>Sets the social buttons. For get more information about this field refer to the documentation.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][social]|id,name" name="slides[<?php echo $key; ?>][social]" id="slides[<?php echo $key; ?>][social]"><?php echo @htmlentities(stripslashes($data['social']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					...
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][ajax]|id,name" name="slides[<?php echo $key; ?>][ajax]" id="slides[<?php echo $key; ?>][ajax]"><?php echo @htmlentities(stripslashes($data['ajax']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					...
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][html5video]|id,name" name="slides[<?php echo $key; ?>][html5video]" id="slides[<?php echo $key; ?>][html5video]"><?php echo @htmlentities(stripslashes($data['html5video']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					...
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][flashvars]|id,name" name="slides[<?php echo $key; ?>][flashvars]" id="slides[<?php echo $key; ?>][flashvars]"><?php echo @htmlentities(stripslashes($data['flashvars']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					...
					<div class="clear"></div>
					<textarea class="html" pattern="slides[_i_][html]|id,name" name="slides[<?php echo $key; ?>][html]" id="slides[<?php echo $key; ?>][html]"><?php echo @htmlentities(stripslashes($data['html']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					
					<label class="label">onAfterLoad</label>
					<small>A function to call when the content loads.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onAfterLoad]|name" name="slides[<?php echo $key; ?>][onAfterLoad]"><?php echo @htmlentities(stripslashes($data['onAfterLoad']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					
					<label class="label">onBeforeLoad</label>
					<small>A function to call before the content loads.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onBeforeLoad]|name" name="slides[<?php echo $key; ?>][onBeforeLoad]"><?php echo @htmlentities(stripslashes($data['onBeforeLoad']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					
					<label class="label">onRender</label>
					<small>A function to call when the content renders.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onRender]|name" name="slides[<?php echo $key; ?>][onRender]"><?php echo @htmlentities(stripslashes($data['onRender']), ENT_QUOTES, 'UTF-8'); ?></textarea>
					<hr>
					
					<label class="label">onShow</label>
					<small>A function to call when the window comes into view.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onShow]|name" name="slides[<?php echo $key; ?>][onShow]"><?php echo @htmlentities(stripslashes($data['onShow']), ENT_QUOTES, 'UTF-8'); ?></textarea>
...
?>
			...
			<div class="slide" id="slide">
				...
				<div class="section collapsed">
					...
					<small>Sets the social buttons. For get more information about this field refer to the documentation.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][social]|id,name" name="slides[__i__][social]" id="slides[__i__][social]"></textarea>
					<hr>
					
					<label class="label" pattern="slides[_i_][ajax]|for" for="slides[__i__][ajax]">Ajax</label>
					<small>Allows extra options to be set when using ajax as your media type.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][ajax]|id,name" name="slides[__i__][ajax]" id="slides[__i__][ajax]"></textarea>
					<hr>
					
					<label class="label" pattern="slides[_i_][html5video]|for" for="slides[__i__][html5video]">HTML5 Video</label>
					<small>Allows extra options to be set when using HTML5 Video.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][html5video]|id,name" name="slides[__i__][html5video]" id="slides[__i__][html5video]"></textarea>
					<hr>
					
					<label class="label" pattern="slides[_i_][flashvars]|for" for="slides[__i__][flashvars]">Flashvars</label>
					<small>Sets flashvars on a flash movie using key/value pairs.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][flashvars]|id,name" name="slides[__i__][flashvars]" id="slides[__i__][flashvars]"></textarea>
					<hr>
					
					<label class="label" pattern="slides[_i_][html]|for" for="slides[__i__][html]">HTML</label>
					<small>Sets HTML Contents when you choose HTML type.</small>
					<div class="clear"></div>
					<textarea class="html" pattern="slides[_i_][html]|id,name" name="slides[__i__][html]" id="slides[__i__][html]"></textarea>
					<hr>
					
					<label class="label">onAfterLoad</label>
					<small>A function to call when the content loads.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onAfterLoad]|name" name="slides[__i__][onAfterLoad]"></textarea>
					<hr>
					
					<label class="label">onBeforeLoad</label>
					<small>A function to call before the content loads.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onBeforeLoad]|name" name="slides[__i__][onBeforeLoad]"></textarea>
					<hr>
					
					<label class="label">onRender</label>
					<small>A function to call when the content renders.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onRender]|name" name="slides[__i__][onRender]"></textarea>
					<hr>
					
					<label class="label">onShow</label>
					<small>A function to call when the window comes into view.</small>
					<div class="clear"></div>
					<textarea class="javascript" pattern="slides[_i_][onShow]|name" name="slides[__i__][onShow]"></textarea>
